...
RUN cp -rvL _build/install/default ocamlformat-0.27.0-built-with-ocaml-5.3.1+relocatable-aarch64-linux-musl-static
RUN tar czf ocamlformat-0.27.0-built-with-ocaml-5.3.1+relocatable-aarch64-linux-musl-static.tar.gz ocamlformat-0.27.0-built-with-ocaml-5.3.1+relocatable-aarch64-linux-musl-static

FROM scratch
COPY --from=builder /home/user/ocamlformat/ocamlformat-0.27.0-built-with-ocaml-5.3.1+relocatable-aarch64-linux-musl-static.tar.gz .
