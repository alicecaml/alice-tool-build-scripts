...
ENV COMPILER_URL="https://github.com/alicecaml/alice-tools/releases/download/5.3.1+relocatable/ocaml-5.3.1+relocatable-aarch64-linux-gnu.tar.gz"
...
RUN cp -rvL _build/install/default dot-merlin-reader-5.4.1-503-built-with-ocaml-5.3.1+relocatable-aarch64-linux-gnu
RUN tar czf dot-merlin-reader-5.4.1-503-built-with-ocaml-5.3.1+relocatable-aarch64-linux-gnu.tar.gz dot-merlin-reader-5.4.1-503-built-with-ocaml-5.3.1+relocatable-aarch64-linux-gnu

FROM scratch
COPY --from=builder /home/user/dot-merlin-reader/dot-merlin-reader-5.4.1-503-built-with-ocaml-5.3.1+relocatable-aarch64-linux-gnu.tar.gz .
